...
const slides = [
  {
    ...
    cta: { label: "Explore Fellowship", href: "/fellowship" },
    cta2: { label: "About Us", href: "/about" },
    bg: "from-teal to-teal-light",
  },
  {
    ...
    cta: { label: "Register Now", href: "/seminar" },
    cta2: { label: "View Gallery", href: "/seminar" },
  ...
  },
  {
    ...
    cta: { label: "Apply Now", href: "/fellowship/apply" },
    cta2: { label: "Track Application", href: "/fellowship/track" },
    bg: "from-gold to-amber-600",
  },
  {
    ...
    cta: { label: "Register", href: "/autism/register" },
    cta2: { label: "Learn More", href: "/autism" },
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 md:py-24 relative z-10">
          <div className="max-w-2xl animate-fade-up" key={current}>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-white/15 backdrop-blur rounded-full mb-5">
              ...
              <span className="text-white/90 text-[11px] font-bold tracking-wider uppercase">{slide.subtitle}</span>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link href={slide.cta2.href} className="inline-flex items-center gap-2 px-5 py-3 border-2 border-white/30 text-white font-semibold rounded-xl hover:bg-white/10 transition-all text-sm">
                {slide.cta2.label}
              </Link>
            </div>
          </div>
