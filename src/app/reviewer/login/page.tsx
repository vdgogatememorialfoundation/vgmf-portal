...
export default function ReviewerLogin() {
  ...
  useEffect(() => {
    fetch("/api/portals/reviewer/status")
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (session?.user?.role !== "REVIEWER" && session?.user?.role !== "JUDGE") {
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-[#0d6662] via-[#14918b] to-[#1a1a2e]">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <h1 className="font-heading text-4xl xl:text-5xl font-extrabold leading-tight mb-4">
            Reviewer <span className="text-[#c2761c]">Portal</span>
          </h1>
          <p className="text-white/70 text-lg max-w-md leading-relaxed">
            Access the review dashboard to evaluate applications and provide structured feedback.
          </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-[#faf9f6] px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8">
            ...
            <span className="font-heading text-xl font-bold text-[#1a1a2e]">VGMF Reviewer</span>
          </div>
          ...
          <div className="mb-8">
            ...
            <h1 className="font-heading text-3xl font-extrabold text-[#1a1a2e] mb-2">Reviewer Login</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="reviewer@vaidyagogate.org"
              />
            </div>
