...
export default function JudgeLogin() {
  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-[#0891b2] via-cyan-600 to-[#1e293b]">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <h1 className="font-heading text-4xl xl:text-5xl font-extrabold leading-tight mb-4">
            Judge / <span className="text-[#d97706]">Reviewer</span> Portal
          </h1>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-[#f8fafc] px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8">
            ...
            <span className="font-heading text-xl font-bold text-[#1e293b]">VGMF Judge</span>
          </div>
          ...
          <div className="mb-8">
            ...
            <h1 className="font-heading text-3xl font-extrabold text-[#1e293b] mb-2">Judge / Reviewer Login</h1>
            <p className="text-[#1e293b]/60">VGMF Review Portal</p>
          </div>
