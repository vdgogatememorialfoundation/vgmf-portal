...
export default function JudgeLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (session?.user?.role !== "JUDGE" && session?.user?.role !== "REVIEWER") {
        await signIn("credentials", { email: "", password: "", redirect: false });
        toast.error("Access denied. Judge/Reviewer privileges required.");
        setLoading(false);
        return;
      }
  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-[#0d6662] via-[#14918b] to-[#1a1a2e]">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <h1 className="font-heading text-4xl xl:text-5xl font-extrabold leading-tight mb-4">
            Judge / <span className="text-[#c2761c]">Reviewer</span> Portal
          </h1>
          <p className="text-white/70 text-lg max-w-md leading-relaxed">
            Access the review dashboard to evaluate applications, provide feedback, and ensure fair governance.
          </p>
          <div className="mt-12 space-y-4">
            {[
              "Review scholarship applications",
              "Evaluate healthcare requests",
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-[#faf9f6] px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8">
            ...
            <span className="font-heading text-xl font-bold text-[#1a1a2e]">VGMF Judge</span>
          </div>
          ...
          <div className="mb-8">
            ...
            <h1 className="font-heading text-3xl font-extrabold text-[#1a1a2e] mb-2">Judge / Reviewer Login</h1>
            <p className="text-[#1a1a2e]/60">VGMF Review Portal</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-xs font-semibold text-[#1a1a2e]/60 uppercase tracking-wider mb-1.5">Email Address</label>
              <input
                type="email"
                value={email}
                ...
                placeholder="judge@vaidyagogate.org"
              />
            </div>
