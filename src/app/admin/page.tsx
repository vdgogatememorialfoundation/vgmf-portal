...
export default function AdminDashboard() {
  const stats = [
    { icon: ShoppingBag, label: "Total Orders", value: "156", change: "+12%", color: "text-blue-600 bg-blue-50" },
    { icon: DollarSign, label: "Revenue", value: "₹2.4L", change: "+8%", color: "text-green-600 bg-green-50" },
    { icon: Package, label: "Products", value: "24", change: "+3", color: "text-purple-600 bg-purple-50" },
    { icon: Users, label: "Users", value: "1,204", change: "+24", color: "text-orange-600 bg-orange-50" },
  ];
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-muted mt-1">Welcome back, Admin</p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl border p-6">
          <h3 className="font-heading text-lg font-bold text-navy mb-4">Registrations</h3>
