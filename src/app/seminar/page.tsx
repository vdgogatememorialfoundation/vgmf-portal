...
export default async function SeminarPage() {
  ...
  if (event.restrictToDoctors && !session) {
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center px-4 max-w-md">
          <Presentation size={48} className="text-[#0891b2] mx-auto mb-4" />
    ...
    <div>
      ...
      <section className="relative bg-gradient-to-br from-[#0891b2] via-[#06b6d4] to-[#22d3ee] py-24 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-0 left-[5%] w-[400px] h-[400px] bg-gold/10 rounded-full blur-[120px]" />
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="card-hover bg-white rounded-3xl border border-gray-100 p-8">
              <div className="w-14 h-14 bg-gradient-to-br from-gold to-gold-light rounded-2xl flex items-center justify-center text-white mb-5 shadow-lg">
                <Users size={24} />
              </div>
      ...
      <section className="py-24 bg-cream-dark">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: Mic, title: "Keynote Lectures", desc: "Eminent speakers from leading Ayurvedic institutions across India sharing cutting-edge research.", color: "from-[#0891b2] to-[#06b6d4]" },
              { icon: Video, title: "Live Demonstrations", desc: "Hands-on Agnikarma and Viddhakarma technique sessions performed by expert practitioners.", color: "from-[#0e7490] to-[#0891b2]" },
              { icon: Award, title: "Paper Presentations", desc: "Research paper submissions with awards and recognition for best presentations.", color: "from-[#0e7490] to-teal" },
            ].map((c, i) => (
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <div key={i} className="card-hover bg-white rounded-3xl border border-gray-100 p-8 text-center group">
                <div className="w-24 h-24 bg-gradient-to-br from-[#0891b2]/10 to-gold/10 rounded-full mx-auto mb-5 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <Users size={36} className="text-[#0891b2]/30" />
                </div>
                <h3 className="font-heading text-lg font-extrabold text-navy">{s.name}</h3>
                <p className="text-sm text-[#0891b2] font-bold mt-1">{s.role}</p>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="card-hover bg-white rounded-2xl border border-gray-100 p-6 flex items-center gap-5">
                <div className="w-16 h-16 bg-gradient-to-br from-[#0891b2] to-[#06b6d4] rounded-2xl flex items-center justify-center text-white font-heading font-extrabold text-lg shrink-0 shadow-lg">
                  {item.year.slice(-2)}
                </div>
                <div>
                  <p className="text-xs font-bold text-[#0891b2] uppercase tracking-wider mb-0.5">{item.year}</p>
