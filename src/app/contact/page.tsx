...
import { MapPin, Phone, Mail, Send, Clock, MessageSquare, CheckCircle, Loader2 } from "lucide-react";
    ...
    <div>
      ...
      <section className="relative bg-navy py-20 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-20 right-[10%] w-[400px] h-[400px] bg-gold/8 rounded-full blur-[120px]" />
          <div className="absolute bottom-10 left-[5%] w-[300px] h-[300px] bg-teal/10 rounded-full blur-[100px]" />
        </div>
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <span className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-sm rounded-full border border-white/10 mb-6">
            ...
            <span className="text-gold-light text-xs font-bold tracking-widest uppercase">Get in Touch</span>
          </span>
          <h1 className="font-heading text-5xl md:text-6xl font-extrabold text-white mb-4">
            Contact <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold to-gold-light">Us</span>
          </h1>
          <p className="text-white/50 text-lg max-w-xl mx-auto">We&apos;d love to hear from you. Reach out with questions, feedback, or partnership inquiries.</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-5">
              {[
                { icon: MapPin, title: "Our Office", value: "102, Ramprasad Chambers, 368/1, Jawaharlal Nehru Rd, near Kirad Hospital, above Shraddha Medicals, New Nana Peth, Pune, Maharashtra 411002", href: "https://maps.google.com/?q=102+Ramprasad+Chambers+Pune+411002", color: "from-navy to-navy-light" },
                { icon: Phone, title: "Phone", value: "+91 93737 92952", href: "tel:+919373792952", color: "from-teal to-teal-light" },
                { icon: Mail, title: "Email", value: "care@vaidyagogate.org", href: "mailto:care@vaidyagogate.org", color: "from-maroon to-maroon-light" },
                { icon: Clock, title: "Office Hours", value: "Mon – Sat: 10:00 AM – 6:00 PM\nSunday: Closed", href: undefined, color: "from-gold to-gold-light" },
              ].map((c, i) => (
                <div key={i} className="card-hover bg-white rounded-2xl border border-gray-100 p-6 group">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="min-w-0">
                      ...
                      {c.href ? (
                        <a href={c.href} target="_blank" rel="noopener noreferrer" className="text-sm text-navy font-medium leading-relaxed hover:text-gold transition-colors whitespace-pre-line">
                          {c.value}
                        </a>
                      ) : (
                ...
                <div className="bg-cream-dark flex items-center justify-center h-48">
                  <div className="text-center">
                    ...
                    <a href="https://maps.google.com/?q=102+Ramprasad+Chambers+Pune+411002" target="_blank" rel="noopener noreferrer"
                      className="text-xs text-gold font-semibold mt-1 inline-block hover:underline">Open in Maps →</a>
                  </div>
                </div>
              </div>
            </div>
