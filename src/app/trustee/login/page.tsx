...
export default function TrusteeLogin() {
  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-gold via-navy-light to-navy">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <div className="w-20 h-20 bg-gold/10 border-2 border-gold/30 rounded-2xl flex items-center justify-center mb-8">
            <Landmark className="text-gold" size={36} />
          </div>
          <h1 className="font-heading text-4xl xl:text-5xl font-extrabold leading-tight mb-4">
            Trustee <span className="text-gold">Portal</span>
          </h1>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8">
            <div className="w-12 h-12 bg-gold rounded-xl flex items-center justify-center">
              <Landmark className="text-navy" size={22} />
            </div>
            <span className="font-heading text-xl font-bold text-navy">VGMF Trustee</span>
          </div>

          <div className="mb-8">
            <div className="w-14 h-14 bg-gold rounded-2xl flex items-center justify-center mb-4">
              <Landmark className="text-navy" size={28} />
            </div>
            <h1 className="font-heading text-3xl font-extrabold text-navy mb-2">Trustee Login</h1>
            <p className="text-muted">VGMF Trustee Portal</p>
          </div>
