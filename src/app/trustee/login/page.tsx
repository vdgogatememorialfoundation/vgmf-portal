...
import { Landmark, ArrowLeft, Eye, EyeOff, Loader2, Lock } from "lucide-react";
...
export default function TrusteeLogin() {
  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-[#0891b2] via-cyan-500 to-[#d97706]">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <h1 className="font-heading text-4xl xl:text-5xl font-extrabold leading-tight mb-4">
            Trustee <span className="text-[#d97706]">Portal</span>
          </h1>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-[#f8fafc] px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8">
            ...
            <span className="font-heading text-xl font-bold text-[#1e293b]">VGMF Trustee</span>
          </div>
          ...
          <div className="mb-8">
            ...
            <h1 className="font-heading text-3xl font-extrabold text-[#1e293b] mb-2">Trustee Login</h1>
            <p className="text-[#1e293b]/60">VGMF Trustee Portal</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-xs font-semibold text-[#1e293b]/60 uppercase tracking-wider mb-1.5">Trustee Email</label>
              <input
                type="email"
                value={email}
