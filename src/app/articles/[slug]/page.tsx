    ...
    <div>
      ...
      <section className="relative bg-gradient-to-br from-[#0891b2] via-[#06b6d4] to-[#22d3ee] py-16 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <Link href="/articles" className="inline-flex items-center gap-2 text-white/60 hover:text-white text-sm font-medium mb-8 transition-colors">
            <ArrowLeft size={16} /> Back to Articles
          </Link>
          {article.category && (
            <span className="inline-flex items-center gap-2 px-3 py-1 bg-white/15 text-white text-xs font-bold rounded-full mb-4 uppercase tracking-wider">
